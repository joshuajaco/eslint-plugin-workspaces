...
module.exports.create = (context) => {
  ...
  /* istanbul ignore if */
  if (scopedEnabled && !scopesDeprecationShown && process.stdout?.isTTY) {
    scopesDeprecationShown = true;

    console.warn(
      "\x1b[1m", // bright
      "\x1b[33m", // yellow text
      "[eslint-plugin-workspaces] Warning: the 'scopes' option of the 'workspaces/no-cross-imports' rule has been deprecated and will be removed in the next major version. See https://github.com/joshuajaco/eslint-plugin-workspaces/blob/099b0d1b603908df5e5fd7ea4775b961f3c91d11/docs/deprecating-scopes.md for more information.",
    );
  }
